...
def loglik_real(batch_data,list_type,theta,normalization_params,kernel_initializer,kernel_regularizer,name,reuse):
...
def loglik_pos(batch_data,list_type,theta,normalization_params,kernel_initializer,kernel_regularizer,name,reuse):
...
def loglik_cat(batch_data,list_type,theta,normalization_params,kernel_initializer,kernel_regularizer,name,reuse):
...
def loglik_ordinal(batch_data,list_type,theta,normalization_params,kernel_initializer,kernel_regularizer,name,reuse):
...
def loglik_count(batch_data,list_type,theta,normalization_params,kernel_initializer,kernel_regularizer,name,reuse):
